...
import me.singleneuron.singleneuronui.databinding.LogFragmentBinding
import me.singleneuron.singleneuronui.utils.ContextUtils.Companion.getSharedPreferenceOnUI
import me.singleneuron.singleneuronui.utils.LogUtils.cleanLog
import java.io.File
...
class LogFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val sharedPreferences = requireContext().getSharedPreferenceOnUI()
